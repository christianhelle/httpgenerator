...
The public crates are `httpgenerator` and `httpgenerator-core`. `httpgenerator-compat` is intentionally private and should not be presented as a user-installable crate.
