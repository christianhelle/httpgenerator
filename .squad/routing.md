...
|-----------|----------|---------|
| Architecture decisions, code review, scope | Ripley | Reviewing PRs, evaluating trade-offs, design decisions |
| CLI implementation, OpenAPI parsing, codegen | Hicks | Adding CLI options, fixing generation bugs, NSwag/OpenApi changes |
| Unit tests, smoke tests, test fixtures | Bishop | Writing xUnit tests, updating smoke-tests.sh |
| README, CHANGELOG, docs, release notes | Hudson | Updating README examples, writing changelog entries |
