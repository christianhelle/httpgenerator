...
fn normalize_specification_version(
    ...
    match document.specification_version() {
        super::OpenApiSpecificationVersion::Swagger2 => NormalizedSpecificationVersion::Swagger2,
        super::OpenApiSpecificationVersion::OpenApi30 => NormalizedSpecificationVersion::OpenApi30,
        super::OpenApiSpecificationVersion::OpenApi31 => NormalizedSpecificationVersion::OpenApi31,
    }
}
