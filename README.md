...
OPTIONS:
    ...
    -o, --output <OUTPUT>                                       ./                   Output directory                                                                                                                                                                   
        ...
        --load-authorization-header-from-environment                                 Load the authorization header from an environment variable or define it in the .http file. You can use --authorization-header-variable-name to specify the environment variable    
                                                                                     name                                                                                                                                                                               
